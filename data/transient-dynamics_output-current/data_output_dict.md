...
# This file is the dictionary to files of the format 'array_outputs_xxxx' #

+ Files were generated within simulation via Jupyter notebook in Python 3.11.5 environment.

+ Dictionary provides information for array_output excel files in both the **example_scenarios** folder and **generated_data** folder within **data_output**.

## Description of columns ##

+ `time`: The time elapsed at each step, generated by the solve_ivp function in python on full model
+ `time_adaptive`: Analogous to time, but generated from adaptive model
...
+ `phage_adaptive`: Phage population at each step, generated from adaptive model
+ `bacteria_adaptive`: Bacteria population at each step, generated from adaptive model
...
+ `process_adaptive`: Analogous to process_full but considering adaptive model conditions
...
+ `weight_growth`: Analogous to weight_growth_full but generated from the adaptive model
+ `weight_predation`: Analogous to weight_predation_full but generated from the adaptive model
+ `weight_burst`: Analogous to weight_burst_full but generated from the adaptive model
+ `weight_decay`: Analogous to weight_decay_full but generated from the adaptive model
+ `weight_carrying_capacity`: Analogous to weight_carrying_capacity_full but generated from the adaptive model
+ `error_phage`: The absolute difference between the full model's and adaptive model's phage population at each time step
+ `error_bacteria`: The absolute difference between the full model's and adaptive model's bacteria population at each time step
